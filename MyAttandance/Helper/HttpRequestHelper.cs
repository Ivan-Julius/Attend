...
namespace MyAttandance.Helper
{
    class HttpRequestHelper
    {
        ...
        public static string notesRequestString(string[] RequestMac, string fDate, string tDate, string[] typeFilter, string[] statusFilter)
        {
            ...
            uri += "approve=" + requestStatusModifier(statusFilter) + "&";
            uri += "reason_type=" + requestTypeModifier(typeFilter);
        ...
        public static string notesConfirmationString(string mac, List<int> id, string approval, string password)
        {
            string uri = BASE_URL + "?";
