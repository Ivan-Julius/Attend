...
{
    class LocationServiceHelper : Object, GoogleApiClient.IConnectionCallbacks, GoogleApiClient.IOnConnectionFailedListener
    {
        ...
        private const long LOCATION_REQUEST_INTERVAL = 10000; //10s
        private const long LOCATION_REQUEST_FASTEST_INTERVAL = 5000; //5s
            ...
            switch (status.StatusCode)
            {
                ...
                case LocationSettingsStatusCodes.ResolutionRequired:
                    ...
                    if (ctx != null)
                    {
                        ...
                        {
                            //LogDataSource.debug(mContext, LOG_TAG, methodName, "PendingIntent unable to execute request.");
