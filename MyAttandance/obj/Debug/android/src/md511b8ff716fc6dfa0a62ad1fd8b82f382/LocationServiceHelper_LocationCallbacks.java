...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyAttandance.LocationServiceHelper+LocationCallbacks, MyAttandance, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LocationServiceHelper_LocationCallbacks.class, __md_methods);
	}
	...
	public LocationServiceHelper_LocationCallbacks () throws java.lang.Throwable
	{
		...
		if (getClass () == LocationServiceHelper_LocationCallbacks.class)
			mono.android.TypeManager.Activate ("MyAttandance.LocationServiceHelper+LocationCallbacks, MyAttandance, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
